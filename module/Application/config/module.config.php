...
return array(
    ...
    'view_helpers' => array(
        'factories' => array(
            ...
            'themeName' =>  function($sm){
                $config = $sm->getServiceLocator()->get('config');
                return new Application\View\Helper\ThemeName($config['themes']);
            }
        ),
    ),
    'translator' => array(
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
            'layout/layout'           => __DIR__ . '/../view/{theme_frontend}/layout.phtml',
            'error/404'               => __DIR__ . '/../view/{theme_frontend}/error/404.phtml',
            'error/index'             => __DIR__ . '/../view/{theme_frontend}/error/index.phtml',
        ),
        'template_path_stack' => array(
            __DIR__ . '/../view/{theme_frontend}',
        )
    ),
);
